...
class Listweekday2ItemWidget extends StatelessWidget {
  Listweekday2ItemWidget(this.listweekday2ItemModelObj);

  Listweekday2ItemModel listweekday2ItemModelObj;

  var controller = Get.find<Months2Controller>();
