                                                                    ...
                                                                    child: Row(
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                              ...
                                                                              decoration: BoxDecoration(color: ColorConstant.lightGreenA700, borderRadius: BorderRadius.circular(getHorizontalSize(2.50)))),
                                                                          Padding(
                                                                              padding: getPadding(left: 2),
                                                                              child: Text("lbl_online".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsLight10.copyWith(height: 1.00)))
                                                                        ])),
                                                                Align(
                                                                    alignment:
                                                                        Alignment
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                          Container(
                                                                              ...
                                                                              child: Text("msg_food_water_le".tr, maxLines: null, textAlign: TextAlign.justify, style: AppStyle.txtPoppinsMedium15WhiteA700.copyWith(height: 1.33))),
                                                                          Container(
                                                                              height: getSize(5.00),
                                                                              width: getSize(5.00),
                                                                              margin: getMargin(top: 2, bottom: 25),
                                                                              decoration: BoxDecoration(color: ColorConstant.redA703, borderRadius: BorderRadius.circular(getHorizontalSize(2.50)))),
                                                                          Padding(
                                                                              padding: getPadding(bottom: 22),
                                                                              child: Text("lbl_offline".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsLight10.copyWith(height: 1.00)))
                                                                        ]))),
                                                                Align(
                                                                    alignment:
                                                                        Alignment
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Text(
                                                                            ...
                                                                            textAlign: TextAlign.left,
                                                                            style: AppStyle.txtPoppinsLight10.copyWith(height: 1.00))))
                                                              ]))
                                                    ]))),
                                        Align(
                                            alignment: Alignment.center,
